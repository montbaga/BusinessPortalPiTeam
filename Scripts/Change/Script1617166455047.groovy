...
WebUI.click(findTestObject('Object Repository/incident/telephonytab'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/incident/voipconnect'))
...
WebUI.click(findTestObject('Object Repository/movecalendarchange'))

WebUI.click(findTestObject('Object Repository/td_21change'))
