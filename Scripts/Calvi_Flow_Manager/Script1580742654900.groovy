...
if (CalviRole.contains('Manager')) {
    println('Calvi Flow for Manager is passed in UI :) ')
} else {
    println('Calvi Flow for Manager is not passed in UI)  :( ')
}
...
println('Calvi Flow for Manager is passed in Database')
