...
if (WebUI.verifyElementClickable(findTestObject('iframeNL'))) {
    WebUI.click(findTestObject('iframeNL'))
}

WebUI.click(findTestObject('Object Repository/Page_My Profile/button_Save'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_My Profile/button_Opslaan'), FailureHandling.CONTINUE_ON_FAILURE)
