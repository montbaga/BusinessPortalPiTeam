...
Windows.click(findWindowsObject('Object Repository/desktop2/Button(3)'))
Windows.click(findWindowsObject('Object Repository/desktop2/Button(4)'))
...
Windows.click(findWindowsObject('Object Repository/desktop2/Button(5)'))

Windows.click(findWindowsObject('Object Repository/desktop2/List'))
