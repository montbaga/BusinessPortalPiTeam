...
WebUI.setText(findTestObject('Object Repository/Page_User Management/input_Select an Account_layoutPane_2_1_1_2_1_1'), 'NOTHING')

WebUI.delay(2)

if (WebUI.verifyElementPresent(findTestObject('Object Repository/tele2supportuser/Page_User Management/left_bpuser' , 4), FailureHandling.STOP_ON_FAILURE)) {
    WebUI.click(findTestObject('Object Repository/tele2supportuser/Page_User Management/left_bpuser')) 
} else {
