...
println(CalviRole)
	...
	if (CalviRole.contains("User Extra")) {
		println("Calvi Flow for User Extra is passed in UI :) ")
	  } else {
		println("Calvi Flow for User Extra is not passed in UI)  :( ")
	  }
...
println("Calvi Flow for User Extra is passed in Database")
